    ...
    <Layout>
      <div className="max-w-3xl mx-auto pb-56 md:pb-8">
        <button
          ...
          className="flex items-center gap-2 text-slate-500 hover:text-slate-800 mb-4 transition text-sm"
        >
        ...
        >
          <div className="max-w-3xl mx-auto px-4 pt-3 pb-3 md:px-0">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => navigate(`/match/${id}/configure`)}
                className="px-5 py-3.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-xl transition text-sm flex-shrink-0"
              >
                Rediger
              </button>
              <button
                onClick={() => navigate(`/match/${id}`)}
                className="flex-1 flex items-center justify-center gap-2.5 py-3.5 text-lg font-bold rounded-xl transition shadow-lg active:scale-[0.98] bg-emerald-600 hover:bg-emerald-700 text-white"
              >
